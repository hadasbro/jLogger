...
import com.github.hadasbro.classes.Utils;
...
public class AspectLogger {
     ...
     * LOGGER
     */
    private static final java.util.logging.Logger LOGGER = java.util.logging.Logger.getLogger(DefaultLogger.class.getName());
        ...
        if(!logOnlyOnRequestValue.equals("") && request != null) {
            ...
            if(splitted.length == 2){
                ...
                try {
                     ...
                     */
                    String strFieldValue = Utils.readFieldValue(
                            Utils.getField(request.getClass(), requiredRequestField.trim()), request
                    );

                    if(strFieldValue != null && !strFieldValue.equals(requiredRequestValue.trim())) {
                        return jpObj;
                    }
